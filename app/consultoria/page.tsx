  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-50">
      <div className="max-w-5xl mx-auto px-4 py-10 md:py-16">
        <div className="rounded-3xl border border-slate-800/70 bg-slate-900/60 shadow-[0_18px_60px_rgba(0,0,0,0.65)] backdrop-blur-xl px-6 py-6 md:px-10 md:py-8">
          ...
          <header className="mb-8">
            ...
            <p className="text-sm md:text-[15px] text-slate-300 leading-relaxed">
              Acompaño a equipos de People &amp; Culture y organizaciones que quieren
              modernizar su operación completa de Recursos Humanos mediante digitalización,
              automatización, analítica e inteligencia artificial. Trabajo con una mirada
              end-to-end del área, abarcando cada etapa del ciclo de vida del colaborador.
            </p>
          </header>

          {/* PROBLEMA / CONTEXTO */}
          <section className="mb-10">
            <h2 className="text-sm md:text-base font-semibold mb-3">El problema hoy</h2>
            <p className="text-sm md:text-[15px] text-slate-300 leading-relaxed mb-4">
              Muchas áreas de HR siguen operando con procesos manuales, dependencias
              individuales, datos dispersos y herramientas subutilizadas. Esto genera cuellos
              de botella, errores, baja trazabilidad, pérdida de tiempo y dificultad para escalar.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="border border-slate-800 rounded-xl p-4 bg-slate-950/60">
                ...
                <ul className="space-y-1 text-[13px] text-slate-200 leading-relaxed">
                  ...
                  <li>· Insights estratégicos para management.</li>
                </ul>
              </div>
              ...
              <div className="border border-slate-800 rounded-xl p-4 bg-slate-950/60">
                ...
                <ul className="space-y-1 text-[13px] text-slate-200 leading-relaxed">
                  ...
                  <li>· Diseño de agentes internos para tareas operativas.</li>
                  <li>· Automatización asistida por IA.</li>
                  <li>· Buenas prácticas, ética y seguridad.</li>
                </ul>
              </div>
            </div>
          </section>

          {/* MINI DASHBOARD DE IMPACTO ESPERADO */}
          <section className="mb-10">
            <h2 className="text-sm md:text-base font-semibold mb-3">
              Impacto esperado en tu área de HR
            </h2>
            <p className="text-sm md:text-[15px] text-slate-300 leading-relaxed mb-4">
              Cada organización es distinta, pero los patrones se repiten: cuando se digitaliza,
              automatiza y ordena la operación de Recursos Humanos, el impacto se ve en horas,
              errores, datos y experiencia del equipo.
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm md:text-[15px] text-slate-300 leading-relaxed mb-4">
              Combino experiencia operativa en Recursos Humanos con herramientas digitales,
              analítica e inteligencia artificial. Trabajo con una metodología práctica,
              pensada para no frenar la operación y generar resultados visibles en poco tiempo.
            </p>
            ...
            <div className="grid gap-4 md:grid-cols-4 text-sm">
              ...
              <div className="border border-slate-800 rounded-xl p-4 bg-slate-950/60 flex flex-col gap-2">
                ...
                <p className="text-[13px] text-slate-200 leading-relaxed">
                  Relevo de procesos, actores, herramientas, dolores y riesgos. Entiendo cómo
                  funciona hoy tu área de HR, sin juzgar, para detectar oportunidades reales de mejora.
                </p>
              </div>
              ...
              <div className="border border-slate-800 rounded-xl p-4 bg-slate-950/60 flex flex-col gap-2">
                ...
                <p className="text-[13px] text-slate-200 leading-relaxed">
                  Definimos juntos qué atacar primero: qué simplificar, qué digitalizar,
                  qué automatizar y qué medir. Armamos un roadmap realista, alineado al negocio
                  y al equipo de HR.
                </p>
              </div>
              ...
              <div className="border border-slate-800 rounded-xl p-4 bg-slate-950/60 flex flex-col gap-2">
                ...
                <p className="text-[13px] text-slate-200 leading-relaxed">
                  Construcción de soluciones con Power Platform, Microsoft 365 y IA, en ciclos cortos.
                  Probamos, ajustamos y desplegamos sin detener la operación, con foco en adopción.
                </p>
              </div>
              ...
              <div className="border border-slate-800 rounded-xl p-4 bg-slate-950/60 flex flex-col gap-2">
                ...
                <p className="text-[13px] text-slate-200 leading-relaxed">
                  Capacitación al equipo, monitoreo de indicadores, ajustes sobre la marcha y nuevas
                  oportunidades de automatización y analítica. La idea es que HR quede empoderado,
                  no dependiente.
                </p>
              </div>
            </div>
          ...
          <section className="border-t border-slate-800 pt-6 mt-6">
            ...
            <p className="text-sm md:text-[15px] text-slate-300 leading-relaxed mb-4">
              Si querés conocer cómo tu equipo puede transformarse, reducir tareas manuales
              y mejorar la calidad de sus datos y procesos, podemos coordinar una reunión.
            </p>
